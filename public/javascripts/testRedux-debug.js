...
store.dispatch((0, _actions.addTodo)('Learn about actions2'));
store.dispatch((0, _actions.setVisibilityFilter)(_actionTypes.VisibilityFilters.SHOW_COMPLETED));
// 停止监听 state 更新
unsubscribe();
...
var SHOW_ALL = _actionTypes.VisibilityFilters.SHOW_ALL;

var initialState = {
    visibilityFilters: _actionTypes.VisibilityFilters.SHOW_ALL,
    todos: []
};
...
function todos() {
    ...
    switch (action.type) {
        ...
        case _actionTypes.TOGGLE_TODO:
            return state.map(function (todoItem, index) {
...
exports.toggleTodo = exports.setVisibilityFilter = exports.removeTodo = exports.addTodo = exports.a = undefined;
...
var removeTodo = exports.removeTodo = function removeTodo(index) {
        return {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__getPrototype_js__ = __webpack_require__(118);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__isHostObject_js__ = __webpack_require__(120);
...
function isPlainObject(value) {
  if (!Object(__WEBPACK_IMPORTED_MODULE_2__isObjectLike_js__["a" /* default */])(value) ||
      objectToString.call(value) != objectTag || Object(__WEBPACK_IMPORTED_MODULE_1__isHostObject_js__["a" /* default */])(value)) {
    return false;
  }
  var proto = Object(__WEBPACK_IMPORTED_MODULE_0__getPrototype_js__["a" /* default */])(value);
  if (proto === null) {
    return true;
  }
