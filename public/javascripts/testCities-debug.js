...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SearchResult = __webpack_require__(3);
	...
	var fakeSearch = function (_Component) {
	    _inherits(fakeSearch, _Component);

	    function fakeSearch() {
	        _classCallCheck(this, fakeSearch);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(fakeSearch).apply(this, arguments));
	    }

	    _createClass(fakeSearch, [{
	        key: 'getInitialState',
	        ...
	        key: 'keywordChange',
	        value: function keywordChange(e) {
	        ...
	        key: 'createResultItems',
	        value: function createResultItems() {
	            var items;
	            items = [1, 2, 3, 4].map(function (item) {
	                return {
	                    value: this.getState('text') + 'item'
	                };
	            });
	            this.setState({
	                items: items
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement('input', { type: 'text', placeholder: 'enterKeyword', onChange: this.keywordChange }),
	                _react2.default.createElement(_SearchResult2.default, { items: this.state.items })
	            );
	        }
	    }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SearchResult = exports.SearchResult = function (_Componont) {
	    _inherits(SearchResult, _Componont);
